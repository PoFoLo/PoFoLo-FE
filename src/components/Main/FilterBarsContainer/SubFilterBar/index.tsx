...
import * as S from '@/components/Main/FilterBarsContainer/SubFilterBar/styles';
import FilterDetailsContainer from '@/components/Main/FilterBarsContainer/SubFilterBar/FilterDetail';
